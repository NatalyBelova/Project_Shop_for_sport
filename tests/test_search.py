...
# """Успешный тест"""
#
# """Проверка верной работы строки поиска по слову 'Кепки'"""
...
#
#
# """Проверка верной работы строки поиска по слову 'Аксессуары'"""
...
#
#     mp = Main_page(driver)
#     mp.search_accessories()
#
#     print("Finish Test 2")
#     driver.quit()
#
#
# """Проверка верной работы строки поиска по слову 'Шарфы'"""
